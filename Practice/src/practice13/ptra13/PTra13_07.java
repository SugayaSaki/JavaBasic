...
public class PTra13_07 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			int superheropower = superHero.attack();
			boolean slimedie = slime.damage(superheropower);
			if (slimedie) {
				System.out.println(superHero.getName() + "は" + slime.getName() + "との戦闘に勝利した");
				break;
			}

			int slimepower = slime.attack();
			boolean superHerodie = superHero.damage(slimepower);
			if (superHerodie) {
