...
public class PTra02_10 {
	public static void main(String[] args) {
		...
		//System.out.println(moneyInHand-(1.08*(coffee*2+snack)));
		double otsuri;
		otsuri=(moneyInHand-(1.08*(coffee*2+snack)));
		System.out.println((int)otsuri);

		//System.out.println(Math.floor(otsuri));
	}
}
